                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: state is WalletSuccess ?  Text(state.data , style: arabicstyle5,) : state is WalletLoading ? const CircularProgressIndicator() : const Text('!'),
                        ),
                      ],
                    ),
                  ],
                   ...
                   Expanded(
                    ...
                    child: Padding(
                      ...
                      child: GestureDetector(
                        onTap: (){
                          context.read<WalletCubit>().chargeWalletData(amount: int.parse(payController.toString()), paymentMethodId: 2);
                        },
                        child: Container(
                          height: 45,
